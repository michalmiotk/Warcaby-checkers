...
#define trzy_srodek 0
#define dwa_srodek 0
#define srodek 0
#define waga_pionek 1000
#define chodzenie_dama 0
Gra::Gra()
{
	Gracz GG1(zolty, 1);
	G[0] = GG1;
...
int Gra::sprpionekkontroler()
{
	for (int m = 0; m < 2; m++) {
		for (int n = 0; n < 12; n++) {
			if (G[m].P[n].zycie == 1 && pozycjakontrolerax == G[m].P[n].pozycjax && pozycjakontroleray == G[m].P[n].pozycjay) {
				if (G[m].kolor == zolty) {
					if (G[m].P[n].dama == 0) return 1;
					else return 11;
				}
				if (G[m].kolor == niebieski) {
					if (G[m].P[n].dama == 0) return 2;
					else return 22;
				}
			}
		}
...
int Gra::poprawnoscruchu()
{
		//dla zoltego pionka
		if (wsk->kolor == zolty && wsk->dama == 0) {
			if (wsk->pozycjax == pozycjakontrolerax + 1 && wsk->pozycjay == pozycjakontroleray - 1) return 1;
			if (wsk->pozycjax == pozycjakontrolerax - 1 && wsk->pozycjay == pozycjakontroleray - 1) return 1;
			else return 0;
		}
		//dla zoltej damy 
		if (wsk->kolor == zolty && wsk->dama == 1) {
			for(int i=1;i<8;i++)
				{
					if (wsk->pozycjax == pozycjakontrolerax + i && wsk->pozycjay == pozycjakontroleray - i)
					{
						int a=0;
						for(int j=1;j<i;j++){
							if(plansza_pokaz[pozycjakontrolerax+j][pozycjakontroleray-j][0]==zolty || plansza_pokaz[pozycjakontrolerax+j][pozycjakontroleray-j][0]==niebieski)
								a++;
						}
						if(a<1)return 1;
					}
		...
		if (wsk->kolor == niebieski && wsk->dama == 0) { 
			if (wsk->pozycjax == pozycjakontrolerax + 1 && wsk->pozycjay == pozycjakontroleray + 1) return 1;
			if (wsk->pozycjax == pozycjakontrolerax - 1 && wsk->pozycjay == pozycjakontroleray + 1) return 1;
			else return 0;
		}
		//dla niebieskiej damy
		if (wsk->kolor == niebieski && wsk->dama == 1) {
				for(int i=1;i<8;i++)
				{
					if (wsk->pozycjax == pozycjakontrolerax + i && wsk->pozycjay == pozycjakontroleray - i)
					{
...
int Gra::sprbicie(e_kolor k1) //zwraca 1 jesli bicie G[0] , 2 jesli bicie G[1] , 0 jesli nie ma bicia
{
	if (k1 == zolty) { //dla pionkow
		for (int n = 0; n < 12; n++) {
			for (int m = 0; m < 12; m++) {
				if (G[0].P[n].dama==0 && G[0].P[n].pozycjax == G[1].P[m].pozycjax + 1 && G[0].P[n].pozycjay == G[1].P[m].pozycjay + 1 && G[0].P[n].zycie == 1 && G[1].P[m].zycie == 1) {  //ruch ¿ó³tych LG
					int a = 0;//zliczaj¹ca
					for (int p = 0; p < 12; p++) {
						...
						if (G[0].P[n].pozycjax == G[1].P[p].pozycjax + 2 && G[0].P[n].pozycjay == G[1].P[p].pozycjay + 2
							...
							a++;
						if (G[0].P[n].pozycjax==1)a++;   //brak spe³nienia powy¿szych warunków gdy¿ pionek dla pozycji x==1 przesuniety o lewo o 2 nie istnieje
						if (G[0].P[n].pozycjay==1)a++;
					}
					if (a<1) return 1;
				}
				if (G[0].P[n].dama==0 && G[0].P[n].pozycjax == G[1].P[m].pozycjax + 1 && G[0].P[n].pozycjay == G[1].P[m].pozycjay - 1 && G[0].P[n].zycie == 1 && G[1].P[m].zycie == 1) {  //ruch ¿ó³tych LD
					int a = 0;//zliczaj¹ca
					for (int p = 0; p < 12; p++) {
						if (G[0].P[n].pozycjax == G[0].P[p].pozycjax + 2 && G[0].P[n].pozycjay == G[0].P[p].pozycjay - 2
							&& G[0].P[n].zycie == 1 && G[0].P[p].zycie == 1
				...
				if (G[0].P[n].dama==0 && G[0].P[n].pozycjax == G[1].P[m].pozycjax - 1 && G[0].P[n].pozycjay == G[1].P[m].pozycjay + 1 && G[0].P[n].zycie == 1 && G[1].P[m].zycie == 1) {  //ruch ¿ó³tych PG
					int a = 0;//zliczaj¹ca
					for (int p = 0; p < 12; p++) {
						if (G[0].P[n].pozycjax == G[0].P[p].pozycjax - 2 && G[0].P[n].pozycjay == G[0].P[p].pozycjay + 2
							&& G[0].P[n].zycie == 1 && G[0].P[p].zycie == 1
				...
				if(G[0].P[n].dama==0 && G[0].P[n].pozycjax == G[1].P[m].pozycjax - 1 && G[0].P[n].pozycjay == G[1].P[m].pozycjay - 1 && G[0].P[n].zycie == 1 && G[1].P[m].zycie == 1) {  //ruch ¿ó³tych PD
					int a = 0;//zliczaj¹ca
					for (int p = 0; p < 12; p++) {
						if (G[0].P[n].pozycjax == G[0].P[p].pozycjax - 2 && G[0].P[n].pozycjay == G[0].P[p].pozycjay - 2
							&& G[0].P[n].zycie == 1 && G[0].P[p].zycie == 1
			...
			if (kontroler == 0) {
  			...
  			if (kontroler == 1) {
				...
				if ((wsk->kolor==zolty && sprbicie(wsk->kolor) == 1) ||(wsk->kolor==niebieski && sprbicie(wsk->kolor) == 2) ) {
	 					if(poprawnoscbicia() == 1 && sprpionekkontroler()==0) {
							usunpionek();
							wsk_pomocniczy=wsk;
							upuscpionek();
							system("cls");
							...
							aktualizuj_plansza_pokaz();
							wyswietlplansze();
							if (sprbicie_pionka(*wsk_pomocniczy,G[0],G[1])==0) //jesli mój pionek którym wykona³em bicie nie mo¿e ju¿ biæ to ruch komputera 
							{
								int x=0;
				...
				if (poprawnoscruchu() == 1  && sprpionekkontroler() == 0 && sprbicie(wsk->kolor)==0) {
					upuscpionek();
					system("cls");
					aktualizuj_damy();
					aktualizuj_plansza_pokaz();
					//
					//jesli wykona³em ruch to teraz
...
void Gra::aktualizuj_plansza_pokaz() // w plansza_pokaz [x][y][0] - kolor zó³ty lub niebieski[x][y][1] - 1 to pionek 2 - dama
{
	for(int i=0;i<8;i++)
	{
		for(int j=0;j<8;j++)
		{
			plansza_pokaz[i][j][0]=0; //kolor 
		}
	}
	for(int i=0;i<12;i++)
	{
		//¿ó³ci
		if(G[0].P[i].zycie == 1 && G[0].P[i].dama==0)
		{
			if(G[0].P[i].pozycjax<8 && G[0].P[i].pozycjax>-1 && G[0].P[i].pozycjay<8 && G[0].P[i].pozycjay>-1)
				plansza_pokaz[G[0].P[i].pozycjax][G[0].P[i].pozycjay][0]=zolty;
				plansza_pokaz[G[0].P[i].pozycjax][G[0].P[i].pozycjay][1]=pionek;
		}
		if(G[0].P[i].zycie == 1 && G[0].P[i].dama==1)
		{
			if(G[0].P[i].pozycjax<8 && G[0].P[i].pozycjax>-1 && G[0].P[i].pozycjay<8 && G[0].P[i].pozycjay>-1)
				plansza_pokaz[G[0].P[i].pozycjax][G[0].P[i].pozycjay][0]=zolty;
				plansza_pokaz[G[0].P[i].pozycjax][G[0].P[i].pozycjay][1]=dama;
		}
		//niebiescy
		if(G[1].P[i].zycie == 1 && G[1].P[i].dama==0)
		{
			if(G[1].P[i].pozycjax<8 && G[1].P[i].pozycjax>-1 && G[1].P[i].pozycjay<8 && G[1].P[i].pozycjay>-1)
				plansza_pokaz[G[1].P[i].pozycjax][G[1].P[i].pozycjay][0]=niebieski;
				plansza_pokaz[G[1].P[i].pozycjax][G[1].P[i].pozycjay][1]=pionek;
		}
		if(G[1].P[i].zycie == 1 && G[1].P[i].dama==1)
		{
			if(G[1].P[i].pozycjax<8 && G[1].P[i].pozycjax>-1 && G[1].P[i].pozycjay<8 && G[1].P[i].pozycjay>-1)
				plansza_pokaz[G[1].P[i].pozycjax][G[1].P[i].pozycjay][0]=niebieski;
				plansza_pokaz[G[1].P[i].pozycjax][G[1].P[i].pozycjay][1]=dama;
		}	
	}
}
void Gra::aktualizuj_plansza_pokaz(Gracz* zolt,Gracz* nieb,int (*plansza_kopia)[8][8][2]) // w plansza_pokaz [x][y][0] - kolor zó³ty lub niebieski[x][y][1] - 1 to pionek 2 - dama
{
	for(int i=0;i<8;i++)
	{
		for(int j=0;j<8;j++)
...
void Gra::aktualizuj_damy()
{
	for(int i=0;i<12;i++)
	{
		...
		{
			if(G[0].P[i].pozycjax<8 && G[0].P[i].pozycjax>-1 && G[0].P[i].pozycjay<8 && G[0].P[i].pozycjay>-1)
				if(G[0].P[i].pozycjay==7) G[0].P[i].wzmocnienie();
		...
		{
			if(G[1].P[i].pozycjax<8 && G[1].P[i].pozycjax>-1 && G[1].P[i].pozycjay<8 && G[1].P[i].pozycjay>-1)
				if(G[1].P[i].pozycjay==0) G[1].P[i].wzmocnienie();	
		}
	}
}
...
int Gra::sprbicie(e_kolor k1, Gracz zolt ,Gracz nieb)//zwraca 1 jesli bicie G[0] , 2 jesli bicie G[1] , 0 jesli nie ma bicia
{
	...
	if (k1 == zolty) { //dla pionkow
		for (int n = 0; n < 12; n++) {
			for (int m = 0; m < 12; m++) {
				if (zolt.P[n].dama==0 && zolt.P[n].pozycjax == nieb.P[m].pozycjax + 1 && zolt.P[n].pozycjay == nieb.P[m].pozycjay + 1 && zolt.P[n].zycie == 1 && nieb.P[m].zycie == 1) {  //ruch ¿ó³tych LG
					int a = 0;//zliczaj¹ca
					for (int p = 0; p < 12; p++) {
						...
						if (zolt.P[n].pozycjax == nieb.P[p].pozycjax + 2 && zolt.P[n].pozycjay == nieb.P[p].pozycjay + 2
							...
							a++;
						if (zolt.P[n].pozycjax==1)a++;   //brak spe³nienia powy¿szych warunków gdy¿ pionek dla pozycji x==1 przesuniety o lewo o 2 nie istnieje
						if (zolt.P[n].pozycjay==1)a++;
					}
					if (a<1) return 1;
				}
				if (zolt.P[n].dama==0 && zolt.P[n].pozycjax == nieb.P[m].pozycjax + 1 && zolt.P[n].pozycjay == nieb.P[m].pozycjay - 1 && zolt.P[n].zycie == 1 && nieb.P[m].zycie == 1) {  //ruch ¿ó³tych LD
					int a = 0;//zliczaj¹ca
					for (int p = 0; p < 12; p++) {
						if (zolt.P[n].pozycjax == zolt.P[p].pozycjax + 2 && zolt.P[n].pozycjay == zolt.P[p].pozycjay - 2
							&& zolt.P[n].zycie == 1 && zolt.P[p].zycie == 1
				...
				if (zolt.P[n].dama==0 && zolt.P[n].pozycjax == nieb.P[m].pozycjax - 1 && zolt.P[n].pozycjay == nieb.P[m].pozycjay + 1 && zolt.P[n].zycie == 1 && nieb.P[m].zycie == 1) {  //ruch ¿ó³tych PG
					int a = 0;//zliczaj¹ca
					for (int p = 0; p < 12; p++) {
						if (zolt.P[n].pozycjax == zolt.P[p].pozycjax - 2 && zolt.P[n].pozycjay == zolt.P[p].pozycjay + 2
							&& zolt.P[n].zycie == 1 && zolt.P[p].zycie == 1
				...
				if(zolt.P[n].dama==0 && zolt.P[n].pozycjax == nieb.P[m].pozycjax - 1 && zolt.P[n].pozycjay == nieb.P[m].pozycjay - 1 && zolt.P[n].zycie == 1 && nieb.P[m].zycie == 1) {  //ruch ¿ó³tych PD
					int a = 0;//zliczaj¹ca
					for (int p = 0; p < 12; p++) {
						if (zolt.P[n].pozycjax == zolt.P[p].pozycjax - 2 && zolt.P[n].pozycjay == zolt.P[p].pozycjay - 2
							&& zolt.P[n].zycie == 1 && zolt.P[p].zycie == 1
...
int Gra::sprbicie_pionka(Pionek pionek, Gracz zolt ,Gracz nieb)//zwraca 1 jesli bicie G[0] , 2 jesli bicie G[1] , 0 jesli nie ma bicia
{
	...
	if (pionek.kolor == zolty){ //dla pionkow
			for (int m = 0; m < 12; m++) {
				if (pionek.dama==0 && pionek.pozycjax == nieb.P[m].pozycjax + 1 && pionek.pozycjay == nieb.P[m].pozycjay + 1 && pionek.zycie == 1 && nieb.P[m].zycie == 1) {  //ruch ¿ó³tych LG
					int a = 0;//zliczaj¹ca
					for (int p = 0; p < 12; p++) {
						...
						if (pionek.pozycjax == nieb.P[p].pozycjax + 2 && pionek.pozycjay == nieb.P[p].pozycjay + 2
							...
							&& -1<nieb.P[p].pozycjax + 2<8 && -1<nieb.P[p].pozycjay + 2<8)
							a++;
						if (pionek.pozycjax==1)a++;   //brak spe³nienia powy¿szych warunków gdy¿ pionek dla pozycji x==1 przesuniety o lewo o 2 nie istnieje
						if (pionek.pozycjay==1)a++;
					}
					if (a<1) return 1;
				}
				if (pionek.dama==0 && pionek.pozycjax == nieb.P[m].pozycjax + 1 && pionek.pozycjay == nieb.P[m].pozycjay - 1 && pionek.zycie == 1 && nieb.P[m].zycie == 1) {  //ruch ¿ó³tych LD
					int a = 0;//zliczaj¹ca
					for (int p = 0; p < 12; p++) {
						if (pionek.pozycjax == zolt.P[p].pozycjax + 2 && pionek.pozycjay == zolt.P[p].pozycjay - 2
				...
				if (pionek.dama==0 && pionek.pozycjax == nieb.P[m].pozycjax - 1 && pionek.pozycjay == nieb.P[m].pozycjay + 1 && pionek.zycie == 1 && nieb.P[m].zycie == 1) {  //ruch ¿ó³tych PG
					int a = 0;//zliczaj¹ca
					for (int p = 0; p < 12; p++) {
						if (pionek.pozycjax == zolt.P[p].pozycjax - 2 && pionek.pozycjay == zolt.P[p].pozycjay + 2
							&& pionek.zycie == 1 && zolt.P[p].zycie == 1
				...
				if(pionek.dama==0 && pionek.pozycjax == nieb.P[m].pozycjax - 1 && pionek.pozycjay == nieb.P[m].pozycjay - 1 && pionek.zycie == 1 && nieb.P[m].zycie == 1) {  //ruch ¿ó³tych PD
					int a = 0;//zliczaj¹ca
					for (int p = 0; p < 12; p++) {
						if (pionek.pozycjax == zolt.P[p].pozycjax - 2 && pionek.pozycjay == zolt.P[p].pozycjay - 2
							&& pionek.zycie == 1 && zolt.P[p].zycie == 1
...
int Gra::wykonaj_ruchy_rekurencja(ruchy* dobry_ruch,e_kolor kolor,int ile_iter,Gracz zolt, Gracz nieb,int pierwsze_wywolanie)
{
	if(ile_iter>0)
	{
		...
		for(int i=0;i<ilosc_ruchow;i++){
			...
			if(kolor==zolty)nowy_kolor=niebieski;
			ruchy jakis_ruch;
			int wynik=0;
			if(bedzie_bicie==1)
...
void Gra::inicjuj_struktura_ruchy(ruchy* struktura){
	struktura->wskaznik_pionek=NULL;
	struktura->nowa_x=0;
	struktura->nowa_y=0;
	struktura->bicie=0;
}
			...
			for (int y = 0; y<8; y++) {
				if (plansza[x][y][0] == k) {
					if (plansza[x][y][1] == pionek) {
						...
						// chodzenie w grupach
						if (plansza[x + 1][y + 1][1] == pionek  && x<7 && y<7 && x>0 && y>0) {
